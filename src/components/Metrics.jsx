      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-5">
          <div className="md:col-span-2 rounded-xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6">
            ...
            <a id="get-started" href="#demo" className="mt-6 inline-flex items-center justify-center rounded-md bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 hover:bg-white/90">Start free pilot</a>
          </div>
        ...
        <div id="docs" className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6">
          <h4 className="text-lg font-semibold">Transparent pricing</h4>
          <p className="mt-2 text-sm text-white/70">Simple per-seat pricing with volume discounts. No setup fees. Request a quote via demo.</p>
        </div>
      </div>
    </section>
  );
