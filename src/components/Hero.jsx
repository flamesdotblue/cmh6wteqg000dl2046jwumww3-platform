    ...
    <section id="home" className="relative h-[88vh] min-h-[600px] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-6 text-center">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/70 backdrop-blur">
          <Bot size={14} /> Agentic AI for Law • YC‑compatible clarity
        </span>
        <h1 className="mt-5 max-w-4xl text-4xl font-semibold tracking-tight md:text-6xl">
          Mirai360 — The AI‑native Operating System for Law Firms
        </h1>
        <p className="mt-4 max-w-2xl text-base text-white/70 md:text-lg">
          Digitize your practice, accelerate drafting, and power case strategy with secure, compliant agentic workflows.
        </p>
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <a href="#product" className="inline-flex items-center justify-center rounded-md border border-white/20 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:border-white/40">
            <Shield className="mr-2 h-4 w-4" /> Explore product
          </a>
        </div>
